		...
		<div id="content" class="narrowcolumn" role="main">
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
					...
					<p class="client"><span>Client:</span> <?php print get_post_meta($post->ID, 'blogClient', true); ?></p>
					<div class="category">
			...
			<?php endwhile; else: ?>
				<h2 class="pagetitle"><?php _e('Sorry, no posts matched your criteria.', 'kubrick'); ?></p>
			<?php endif; ?>
		</div>
